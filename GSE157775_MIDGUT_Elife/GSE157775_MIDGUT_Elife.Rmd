...
# Example usage:
MIDGUT_Elife <- merge_metadata(MIDGUT_Elife, Author_metadata,cell_id_col = "cellID")

```

change active ident to assigned_cell_type
```{r}
Idents(MIDGUT_Elife) <- MIDGUT_Elife@meta.data$assigned_cell_type
```
