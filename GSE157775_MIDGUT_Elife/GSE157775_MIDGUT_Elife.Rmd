...
MIDGUT_Elife3 <- JoinLayers(MIDGUT_Elife3,assay = "RNA")

all.markers <- FindAllMarkers(MIDGUT_Elife3, test.use = 'MAST', only.pos = TRUE, min.pct = 0.10, logfc.threshold = 0.25,group.by="annotation")
