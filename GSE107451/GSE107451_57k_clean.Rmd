...
p <- ggvenn(gene_sets, fill_color = c("grey", "grey", "grey"), stroke_size = 0.5, set_name_size = 4,fill_alpha = 0.5,text_size = 3)

# Add annotations for intersecting genes
p + 
  annotate("text", x = 0, y = 0.5, label = paste(setdiff(intersect_12, intersect_123), collapse = ", "), size = 3) +  # Intersection of List1 and List2 excluding intersect_123
  annotate("text", x = 0, y = -1, label = paste(setdiff(gene_list3, intersect_123), collapse = ", "), size = 3) +   # gene_list3 excluding intersect_123
  annotate("text", x = 0, y = 0, label = paste(intersect_123, collapse = ", "), size = 3) +    # Intersection of all three lists
  annotate("text", x = 0.8, y = 0.4, label = paste(setdiff(gene_list2, intersect_12), collapse = ", "), size = 3)     # gene_list3 excluding intersect_12
```
