...
Export FindAllMarkers result For IMs, female_target_ImmuneGenes_50, and male_target_ImmuneGenes_50
Note: female_target_ImmuneGenes_50 and male_target_ImmuneGenes_50 are generated in latter section when DEseq was performed on aggregated count to compare to Bulk RNAseq data.
```{r}
# IMs
...
openxlsx::write.xlsx(lowest_standard_markers[lowest_standard_markers$gene%in%female_target_ImmuneGenes_50,],
                     "./processed_data/lowest_standard_markers_female_target_ImmuneGenes_50.xlsx",
                     rowNames=T)
# male_target_ImmuneGenes_50
openxlsx::write.xlsx(lowest_standard_markers[lowest_standard_markers$gene%in%male_target_ImmuneGenes_50,],
                     "./processed_data/lowest_standard_markers_male_target_ImmuneGenes_50.xlsx",
                     rowNames=T)

```


Import the FindAllMarkers results for IMs, female_target_ImmuneGenes_50, and male_target_ImmuneGenes_50
```{r}
lowest_standard_markers_III_markers <- read.xlsx("./processed_data/lowest_standard_markers_III_markers.xlsx",
                                                 rowNames = T,
                                                 colNames = T)
lowest_standard_markers_female_target_ImmuneGenes_50 <- read.xlsx("./processed_data/lowest_standard_markers_female_target_ImmuneGenes_50.xlsx",
                                                 rowNames = T,
                                                 colNames = T)
lowest_standard_markers_male_target_ImmuneGenes_50 <- read.xlsx("./processed_data/lowest_standard_markers_male_target_ImmuneGenes_50.xlsx",
                                                 rowNames = T,
                                                 colNames = T)
```
...
#dotplot of female_target_ImmuneGenes_50
female_target_ImmuneGenes_50_dotplot <- DotPlot(ALL_HEAD_57k3, features = female_target_ImmuneGenes_50,group.by = "annotation")+
...
pdf("./results/Dotplot/female_target_ImmuneGenes_50_dotplot.pdf",
    width = 25,
    height = 6)
female_target_ImmuneGenes_50_dotplot
dev.off()

# Make another dot plot that only includes annotated clusters
pdf("./results/Dotplot/female_target_ImmuneGenes_50_dotplot_annotated.pdf",
    width = 15,
    height = 5)
DotPlot(subset(ALL_HEAD_57k3, idents = annotated_clusters), features = female_target_ImmuneGenes_50,group.by = "annotation")+
...
#dotplot of female_target_ImmuneGenes_30
female_target_ImmuneGenes_30_dotplot <- DotPlot(ALL_HEAD_57k3, features = female_target_ImmuneGenes_30,group.by = "annotation")+
    theme(axis.text.x = element_text(angle = 90, size = 12), legend.text = element_text(size = 12), legend.title = element_text(size = 12))+
  coord_flip()

#export dotplot of female_target_ImmuneGenes_30
pdf("./results/Dotplot/female_target_ImmuneGenes_30_dotplot.pdf",
    width = 25,
    height = 6)
female_target_ImmuneGenes_30_dotplot
dev.off()

# Make another dot plot that only includes annotated clusters
pdf("./results/Dotplot/female_target_ImmuneGenes_30_dotplot_annotated.pdf",
    width = 15,
    height = 5)
DotPlot(subset(ALL_HEAD_57k3, idents = annotated_clusters), features = female_target_ImmuneGenes_30,group.by = "annotation")+
    theme(axis.text.x = element_text(angle = 90, size = 8), axis.text.y = element_text(size = 8), legend.text = element_text(size = 8), legend.title = element_text(size = 8))+
  coord_flip()
dev.off()
```
...
#dotplot of male_target_ImmuneGenes_50
male_target_ImmuneGenes_50_dotplot <- DotPlot(ALL_HEAD_57k3, features = male_target_ImmuneGenes_50,group.by = "annotation")+
    theme(axis.text.x = element_text(angle = 90, size = 12), legend.text = element_text(size = 12), legend.title = element_text(size = 12))+
  coord_flip()

#export dotplot of male_target_ImmuneGenes_50
pdf("./results/Dotplot/male_target_ImmuneGenes_50_dotplot.pdf",
    width = 25,
    height = 6)
male_target_ImmuneGenes_50_dotplot
dev.off()

# Make another dot plot that only includes annotated clusters
pdf("./results/Dotplot/male_target_ImmuneGenes_50_dotplot_annotated.pdf",
    width = 15,
    height = 5)
DotPlot(subset(ALL_HEAD_57k3, idents = annotated_clusters), features = male_target_ImmuneGenes_50,group.by = "annotation")+
    theme(axis.text.x = element_text(angle = 90, size = 8), axis.text.y = element_text(size = 8), legend.text = element_text(size = 8), legend.title = element_text(size = 8))+
  coord_flip()
dev.off()
```
...
male 30
```{r}
#dotplot of male_target_ImmuneGenes_30
male_target_ImmuneGenes_30_dotplot <- DotPlot(ALL_HEAD_57k3, features = male_target_ImmuneGenes_30,group.by = "annotation")+
    theme(axis.text.x = element_text(angle = 90, size = 12), legend.text = element_text(size = 12), legend.title = element_text(size = 12))+
  coord_flip()

#export dotplot of male_target_ImmuneGenes_30
pdf("./results/Dotplot/male_target_ImmuneGenes_30_dotplot.pdf",
    width = 25,
    height = 6)
male_target_ImmuneGenes_30_dotplot
dev.off()

# Make another dot plot that only includes annotated clusters
pdf("./results/Dotplot/male_target_ImmuneGenes_30_dotplot_annotated.pdf",
    width = 15,
    height = 5)
DotPlot(subset(ALL_HEAD_57k3, idents = annotated_clusters), features = male_target_ImmuneGenes_30,group.by = "annotation")+
    theme(axis.text.x = element_text(angle = 90, size = 8), axis.text.y = element_text(size = 8), legend.text = element_text(size = 8), legend.title = element_text(size = 8))+
  coord_flip()
dev.off()
```
...
pdf("./results/Dotplot/WB_IMs_dotplot.pdf",
    width = 25,
    height = 6)
...
# Make another dot plot that only includes annotated clusters
pdf("./results/Dotplot/WB_IMs_dotplot_annotated.pdf",
    width = 15,
    height = 5)
...
# plot log2((old expression + 1) / (young expression + 1)) for common clusters
