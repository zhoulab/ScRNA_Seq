...
## TPM_HEAD_Genotype_Sex_Age_Cluster: aggregated count normalized to TPM
...
for (i in 1:length(III_Marker_Genes)) {
  ...
  ggsave(tmp,device = "pdf",file= paste0("./results/Featureplot/Featureplot_HEAD57k_",III_Marker_Genes[i],".pdf"),width = 9,height = 6)
}
...
ggsave(Seurat::FeaturePlot(ALL_HEAD_57k3, features = "noe",  cols = c("grey","darkred"), reduction = "tSNE_ALL_HEAD_57k_Author_cluster",keep.scale = "feature"),
       device = "pdf",file= paste0("./results/Featureplot/Featureplot_HEAD57k_","noe",".pdf"),width = 9,height = 6)
...
ggsave(Seurat::FeaturePlot(ALL_HEAD_57k3, features = "pros",  cols = c("grey","darkred"), reduction = "tSNE_ALL_HEAD_57k_Author_cluster",keep.scale = "feature"),
       device = "pdf",file= paste0("./results/Featureplot/Featureplot_HEAD57k_","pros",".pdf"),width = 9,height = 6)
```
...
for (i in 1:length(III_Marker_Genes)) {
  ...
  ggsave(tmp2,device = "pdf",file= paste0("./results/Vlnplot/Vlnplot_HEAD57k_Genotype_",III_Marker_Genes[i],".pdf"),width = 9,height = 6)
}
...
ggsave(Seurat::VlnPlot(ALL_HEAD_57k3, features = "noe",group.by = "Genotype")
       ,device = "pdf",file= paste0("./results/Vlnplot/Vlnplot_HEAD57k_Genotype_","noe",".pdf"),width = 9,height = 6)
...
for (i in 1:length(III_Marker_Genes)) {
  ...
  ggsave(tmp3,device = "pdf",file= paste0("./results/Vlnplot/Vlnplot_HEAD57k_Age_",III_Marker_Genes[i],".pdf"),width = 9,height = 6)
}
#This vlnplot of noe is used to demonstrate what vlnplot looks like when there is enough cells expressing a gene
ggsave(Seurat::VlnPlot(ALL_HEAD_57k3, features = "noe",group.by = "Age")
       ,device = "pdf",file= paste0("./results/Vlnplot/Vlnplot_HEAD57k_Age_","noe",".pdf"),width = 9,height = 6)
...
pdf("./results/Dotplot/III_Markers_dotplot.pdf",
    width = 30,
    height = 10)
...
The input should be a dataframe split by genotype, sex, age, and celltype
```{r}
