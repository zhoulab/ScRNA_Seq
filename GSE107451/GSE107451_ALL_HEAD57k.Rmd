...
plot_log2bars_Ages <- function(DATA, GENE, STRAIN, SEX, AGE1, AGE2) {
  ...
  DATA_AGE2 <- DATA[,which(str_split(colnames(DATA),pattern = "_",4,simplify =T)[,3]==AGE2)];
  
  
  
  barplot(log2(as.matrix(DATA_AGE1[GENE,])),
          xlim=c(0,20), 
          ylim=c(0,20),
          width=0.2,
          main=paste0("log2(Expression)"," at day ",AGE1," of ", GENE," in ",STRAIN," ",SEX), 
  ...
  barplot(log2(as.matrix(DATA_AGE2[GENE,])),
          xlim=c(0,20), 
          ylim=c(0,20),
          width=0.2,
          main=paste0("log2(Expression)"," at day ",AGE2," of ", GENE," in ",STRAIN," ",SEX), 
          names.arg=str_split(colnames(DATA_AGE2),pattern = "_",4,simplify =T)[,4],
          ylab="log2Expression level", 
          xlab="Clusters",
          col=c("red"),
          cex.names=0.2,
